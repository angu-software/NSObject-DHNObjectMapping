Pod::Spec.new do |s|
  ...
  s.version      = "1.0.0"
  s.summary      = "A category to map the values of a NSDictionary representation of an object to the objets properties."
  s.description  = <<-DESC
                   ...
                   in the dictionary representation its value gets maped to the property on the data object.
                   You can change this default behavour. But in general you only need to handle special mapping for your 
                   objects.
                   DESC
  ...
  s.platform     = :ios, "7.0"
  s.source       = { :git => "http://EXAMPLE/DHNObjectMapping.git", :tag => s.version}
